...
func TestSyncClient_FindQuery(t *testing.T) {
	cli := NewSyncClient()
	var r = make([]map[string]interface{}, 0)
	query := `{"filter":{"device.driver":"test","$lookups":[{"from":"node","localField":"_id","foreignField":"model","as":"devices"},{"from":"node","localField":"devices.parent","foreignField":"_id","as":"devicesParent"},{"from":"model","localField":"devicesParent.model","foreignField":"_id","as":"devicesParentSync"}]},"project":{"device":1,"devices":1,"devicesParent":1,"devicesParentSync":1}}`
...
func TestSyncClient_FindById(t *testing.T) {
	cli := NewSyncClient()
...
func TestSyncClient_Save(t *testing.T) {
	cli:= NewSyncClient()
...
func TestSyncClient_ReplaceById(t *testing.T) {
	cli := NewSyncClient()
	var r = make(map[string]interface{})
...
func TestSyncClient_UpdateById(t *testing.T) {
	cli := NewSyncClient()
...
func TestSyncClient_DelById(t *testing.T) {
	cli := NewSyncClient()
	var r = make(map[string]interface{})
