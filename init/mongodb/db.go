...
func FindFilter(ctx context.Context, col *mongo.Collection, result *[]bson.M, query bson.M, calc CalcPipelineFunc) (int, error) {
...
// FindFilter 根据条件查询数据(原版)
// result:查询结果 query:查询条件
//func FindFilterDeptQuery(ctx context.Context, col *mongo.Collection, result *[]bson.M, query bson.M, calc CalcPipelineFunc) (int, error) {
//
//	var count int
//	projectMap := bson.M{}
//
...
// result:查询结果 query:查询条件
func FindFilterLimit(ctx context.Context, col *mongo.Collection, result *[]bson.M, query bson.M, calc CalcPipelineFunc) (int, error) {
